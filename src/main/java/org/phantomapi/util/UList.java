...
public class UList<T> extends ArrayList<T>
{
	...
	public T mostCommon()
	{
		UMap<T, Integer> common = new UMap<T, Integer>();
	 ...
	 */
	public UList<String> stringList()
	{
	 ...
	 */
	public UList<T> cropFrom(int from)
	{
		return crop(from, size() - 1);
	}
	
	public UList<UList<T>> split(int factor)
	{
		UList<UList<T>> factors = new UList<UList<T>>();
	 ...
	 * @return the cropped glist
	 */
	public UList<T> crop(int from, int to)
	{
		UList<T> crop = new UList<T>();
